...
Begin VB.Form frmSP52831 
   ...
   Begin FPSpreadADO.fpSpread fpSpread1 
      ...
      SpreadDesigner  =   "frmSP52831Neu.frx":0310
      UnitType        =   2
      ScrollBarTrack  =   3
   End
   Begin FPSpreadADO.fpSpread fpSpread1 
      ...
      RetainSelBlock  =   0   'False
      ScrollBarShowMax=   0   'False
      SpreadDesigner  =   "frmSP52831Neu.frx":4816
      UnitType        =   2
      ScrollBarTrack  =   3
   End
   Begin FPSpreadADO.fpSpread fpSpread1 
      ...
      RetainSelBlock  =   0   'False
      ScrollBarShowMax=   0   'False
      SpreadDesigner  =   "frmSP52831Neu.frx":8D1C
      UnitType        =   2
      ScrollBarTrack  =   3
   End
  ...
  Case COL_ARTSCHL
    ...
    If objDAusw.Abbruch = False Then
      If gbZeileInCopy = False Then
        LR = LastRow - Row
        If LR > 0 Then ZeileBearbeiten 1, Row + 1, LR
      End If
      ...
      Case "A"
        ...
        If Trim(objDAusw.FieldText(12)) <> "" Then
          If LR > 0 Then ZeileBearbeiten 4, Row + 1, LR
      ...
      Case "T"
        ...
        If LR > 0 Then
          If TextRows > 1 Then ZeileBearbeiten 4, Row + 1, LR
        End If
...
Public Sub ZeileBearbeitenSicher(Aktion As Integer, Row As Long, Anzahl As Long)
  'Aktion - 1=Kopieren
  '         2=Ausschneiden
  '         3=Einfügen
...
Public Sub ZeileBearbeiten(Aktion As Integer, Row As Long, Anzahl As Long)
  ...
  Case 1 'Kopieren
    ...
    gbZeileInCopy = True
  Case 2 'Ausschneiden
    ZeileBearbeiten 1, Row, Anzahl
    ZeileBearbeiten 4, Row, Anzahl
  Case 3 'Einfügen
    'If UBound(gFPArray, 1) > -1 Then
    If gbZeileInCopy Then
      'Erste Spalte des Grids füllen.
